        ...
        <div class="col-md-12 col-md-12"> 
            <div class="card shadow mb-4">
                ...
                <div class="nova">
                    ...
                    <i class="fas fa-fw fa-list"></i> Add role 
                    </button>
                </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="my-modal-title">Novo role</h5>
                                <button class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                            <form class="was-validated"  method="post" action="/roles" enctype="multipart/form-data">
                                @csrf  
                                ...
                                <div class="row row-cols-1"> 
                                    <div class="col"> 
                                        ...
                                        <input type="text" id="guard_name" placeholder="Descrição" name="guard_name" class="form-control" required="" >
                                        <div class="valid-feedback"></div> 
                                        <div class="invalid-feedback">Campo obrigatório.</div>
                                    </div>  
                                </div>     
