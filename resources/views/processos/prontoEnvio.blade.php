...
@section('title', ' Processos Prontos - Enviar ao notificante')

@section('content')


     <!-- Breadcrumbs -->
     {{ Breadcrumbs::render('Processos Prontos') }}
        ...
        <div class="col-md-12 col-md-12"> 
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary"> Processos Prontos - Aguardando envio dos anexos</h6>
                </div> 
                <div class="card-body">  
                 <!--end Large modal -->
                    <div class="card-body">
