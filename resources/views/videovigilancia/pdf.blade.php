     ...
     <main>
         <div class="row" id="geral">
             ...
             <div class="col-md-12" id="cabecalho">
                 Notificação de videovigilância <b> - {{ $pedido->tipo_cctv }}</b>
             </div>
             <div class="col-md-12"><br></div>
             ...
             <div class="col-md-12" id="nameCenter"><b>Pessoa:</b> {{ $pedido->tipo_pessoa }}</td>
                 ...
                 <table>
                     <tr>
                         <th> Nº total de Câmaras:</th>
                         <td>{{ $pedido->numero_camaras }}</td>
                     </tr>
                     <tr>
                         <th> Quem tem acesso as imagens em tempo real:</th>
                         <td>{{ $pedido->quem_tem_acesso_imagens }}</td>
                     </tr>
                     <tr>
                         <th> Local para onde e realizada a transmissão:</th>
                         <td>{{ $pedido->local_transmissao_imagens }}</td>
                     </tr>
                     <tr>
                         <th>
                             Zonas Abrangidas:
                     ...
                     <tr>
                         <th> Outras zonas abrangidas:</th>
                         <td>{{ $pedido->outraszonas_abrangidas }}</td>
                     </tr>
                 </table>
