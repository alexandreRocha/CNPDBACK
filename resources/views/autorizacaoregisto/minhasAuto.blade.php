...
@section('title', 'Minhas Autorizações')

@section('content')


     <!-- Breadcrumbs -->
     {{ Breadcrumbs::render('Minhas Autorizações') }}
        ...
        <div class="col-md-12 col-md-12"> 
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary"> Minhas Autorizações</h6>
                </div> 
                <div class="card-body">  
                 <!--end Large modal -->
                    <div class="card-body">
