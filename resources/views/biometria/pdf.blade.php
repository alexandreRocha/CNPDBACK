    ...
    <main>
        <div class="row" id="geral">
            ...
            <div class="col-md-12" id="cabecalho">
                <b> Notificação de Tratamento de Dados Biométricos</b>
            </div>
            <div class="col-md-12"><br></div>
            ...
            <div class="col-md-12" id="nameCenter"><b>Pessoa:</b> {{ $pedido->tipo_pessoa }}</td>
                ...
                <table>
                    <tr>
                        ...
                        <td> 
                            ...
                            @foreach ($pedido->finalidade_tratamento as $finalidadetrata)
                                {{ $finalidadetrata }}<b> | </b>
                            @endforeach
                        @endif
                        </td>
                ...
                <table>
                    <tr>
                        ...
                        @if ($pedido->dados_registrados)
                            @foreach ($pedido->dados_registrados as $dadosregistado)
                                {{ $dadosregistado }}<b> | </b>
                            @endforeach
                        @endif
                        </td>
                    ...
                    <tr>
                        ...
                        @if ($pedido->outros_dados)
                            @foreach ($pedido->outros_dados as $outrodado)
                                {{ $outrodado }}<b> | </b>
                            @endforeach
                        @endif
                        </td>
                ...
                <table>
                    <tr>
                        ...
                        @if ($pedido->forma_registro)
                            @foreach ($pedido->forma_registro as $forma)
                                {{ $forma }}<b> | </b>
                            @endforeach
                        @endif
                        </td>
                ...
                <table>
                    <tr>
                        <th> Forma de tratamento da informação:</th>
                        <td> 
                         {{ $pedido->forma_tratamento_informacao }}
                        </td>
                    </tr>
                </table>
                ...
                <table>
                    <tr>
                        <th> Catálago do equipamento:</th>
                        <td>
                            @if ($pedido->catalago_equipamento)
                            <p>Foi enviado o catálago do equipamento</p>
                            @elseif (!$pedido->parececatalago_equipamentor_representante_trabalhadore)
                            <p>Não foi enviado o catálago do equipamento</p>
                            @endif
                        </td>
                    </tr>
                </table>
